  ...
  return (
    <div>
        ...
        <div className="mt-6 space-y-5">
          <Link to="/mypage/edit" className="w-full h-7 px-20 flex justify-between items-center">
            <span className="font-bold text-gray-500">프로필 정보 변경</span>
            <IoIosArrowForward className="text-gray-500" />
          </Link>
          <Link to="/mypage/protector" className="w-full h-7 px-20 flex justify-between items-center">
